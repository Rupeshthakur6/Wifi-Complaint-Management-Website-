...
<meta charset="utf-8" />
<title>User | Complain Support</title>
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">View Complain</a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Complain Support</h3>
      </div>
      <div class="clearfix"></div>
      
      <h4> <span class="semi-bold">Complain</span></h4>
      <br>
     <?php $rt=mysqli_query($con,"select * from Complain where email_id='".$_SESSION['login']."'");
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">Complain #<?php echo $row['complain_id'];?></span> - Created on <?php echo $row['posting_date'];?>
