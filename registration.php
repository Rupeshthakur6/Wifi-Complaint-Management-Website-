...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to WCM</h2>
          <p>            <a href="login.php">Sign in Now!</a> for a WiFi Complaint Management account. It's free and always will be.</p>
          <br>
