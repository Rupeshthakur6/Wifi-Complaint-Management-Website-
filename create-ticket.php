...
<meta charset="utf-8" />
<title>WCM | Create  Complain</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <div class="form-group">                                        
									 ...
									 <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Issue Type</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select  name="tasktype" class="form-control select" required>
                                                <option> Select your Issue</option>
                                                <option value="billing">Router Issues</option>
                                                <option value="ot1">Slow Connection</option>
                                                <option value="ot2">Connection Drops</option>
